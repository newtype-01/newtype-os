...
[**Download newtype Workstation 0.3.21 for Apple Silicon**](https://github.com/newtype-01/newtype-os/releases/download/workstation-latest/newtype-workstation-mac-arm64.dmg)

Requirements: Apple Silicon (M1 or later) and macOS 11.5 or later.

Version 0.3.21 (Build 29) bundles newtype CLI 0.0.90. Session requests use bounded, message-correlated waits; interrupted content runs stop safely after restart, and intermediate specialist tool turns can no longer be mistaken for final replies.
...
SHA-256: `6383ef7a830fe50186e34b4b07440a3115bfaa153b9438b8587f431a4e7c75f0`
